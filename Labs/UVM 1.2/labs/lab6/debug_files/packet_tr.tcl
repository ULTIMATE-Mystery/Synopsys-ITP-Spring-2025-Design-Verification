...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{76 179} {1527 1038}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 132} {height 266} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 199]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
catch { set Local.1 [gui_share_window -id ${DLPane.1} -type Local -silent] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 199
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 640
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 198} {height 266} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Transaction.1 [gui_create_window -type Transaction -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 385]
gui_set_window_pref_key -window ${Transaction.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Transaction.1} -key dock_height -value_type integer -value 385
gui_set_window_pref_key -window ${Transaction.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1451} {height 384} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 115} {child_transaction_col_message 245} {child_transaction_col_caller 68} {child_transaction_col_name 49} {child_transaction_col_scope 124} {child_transaction_col_severity 74} {child_transaction_col_type 72} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1451} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{357 95} {1487 861}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 331} {child_wave_right 794} {child_wave_colname 217} {child_wave_colvalue 110} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_transaction_select_message -design V1 -id Transaction.1 -logid -1 -msgid -1 -time 0 -scope {} -stream {LOG$RSTCFG} -caller {test.unnamed$$_2.unnamed$$_2.unnamed$$_1.run_test.\uvm_root::run_test .\uvm_root::run_test .unnamed$$_12.\uvm_root::run_test .unnamed$$_12.unnamed$$_13.\uvm_phase::m_run_phases .\uvm_phase::m_run_phases .unnamed$$_1.\uvm_phase::m_run_phases .unnamed$$_1.unnamed$$_5.\uvm_phase::m_run_phases .unnamed$$_1.unnamed$$_5.unnamed$$_6.\uvm_phase::execute_phase .\uvm_topdown_phase::traverse .\uvm_topdown_phase::traverse .\uvm_topdown_phase::traverse .\uvm_topdown_phase::traverse .unnamed$$_4.\uvm_topdown_phase::execute .\uvm_build_phase::exec_func .\reset_agent::build_phase .\uvm_report_object::uvm_report_info .\uvm_report_object::uvm_report .\uvm_report_object::uvm_process_report_message .\uvm_report_handler::process_report_message .\uvm_default_report_server::process_report_message .\uvm_report_catcher::process_all_report_catchers .unnamed$$_3.\uvm_report_catcher::process_report_catcher .\vcs_smartlog_catcher::catch } -occurrence 0 -group {} -incidence 0

# Source 'Source.1'
gui_src_value_annotate -id ${Source.1} -switch false
gui_set_env TOGGLE::VALUEANNOTATE 0
gui_open_source -id ${Source.1}  -replace -active router_test_top /remote/us01home17/jachang/ces_uvm-1.2_2014.12/rtl/router_test_top.sv
...
if {[gui_exist_window -window ${TopLevel.1}]} {
	...
	gui_set_active_window -window ${Transaction.1}
}
#</Session>