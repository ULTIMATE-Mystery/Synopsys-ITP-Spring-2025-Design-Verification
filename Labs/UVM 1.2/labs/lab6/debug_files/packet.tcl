...
# DVE full session
# Saved on Thu Jul 28 13:18:40 2016
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/remote/us01home17/jachang/ces_uvm-1.2_2016.06/labs/lab6/debug_files/packet.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{48 167} {1250 1033}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 139} {height 455} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 206]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
catch { set Local.1 [gui_share_window -id ${DLPane.1} -type Local -silent] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 206
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 640
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 205} {height 455} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Transaction.1 [gui_create_window -type Transaction -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 203]
gui_set_window_pref_key -window ${Transaction.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Transaction.1} -key dock_height -value_type integer -value 203
gui_set_window_pref_key -window ${Transaction.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1202} {height 202} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 92} {child_transaction_col_message 63} {child_transaction_col_caller 68} {child_transaction_col_name 44} {child_transaction_col_scope 94} {child_transaction_col_severity 56} {child_transaction_col_type 38} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1202} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{380 316} {1517 1115}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 331} {child_wave_right 801} {child_wave_colname 163} {child_wave_colvalue 164} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_load_child_values {router_test_top.host_if}
...
set _session_group_3 host_if
gui_sg_create "$_session_group_3"
set host_if "$_session_group_3"

gui_sg_addsignal -group "$_session_group_3" { {router_test_top.host_if.$unit} router_test_top.host_if.wr_n router_test_top.host_if.rd_n router_test_top.host_if.address router_test_top.host_if.data router_test_top.host_if.clk }
...
gui_list_show_data -id ${Data.1} {router_test_top.host_if}
...
gui_open_source -id ${Source.1}  -replace -active router_test_top /remote/us01home17/jachang/ces_uvm-1.2_2016.06/rtl/router_test_top.sv
...
gui_wv_zoom_timerange -id ${Wave.1} 0 39235
...
gui_list_set_insertion_bar  -id ${Wave.1} -group host_if  -position in
