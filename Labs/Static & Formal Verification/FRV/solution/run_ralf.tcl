...
# read RALF file and generate FRV checker file
...
# Disable FRV assertion
# IPXACT & RALF differences
# No equivalent specification in RALF to IPXACT's "write-only + 1-to-clear"
fvdisable {*.i_DMAC.i_INTR_CTRL__INTRCLR_0x0.RW.CHKBDR.BDRRD.ast_rw_bdr_read_check}
