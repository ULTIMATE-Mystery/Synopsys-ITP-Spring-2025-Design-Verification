...
proc compile_impl {} {
    ...
    vcs -sverilog -pvalue+SIZE=64 -f ../rtl/files_a
...
proc case_split_64 {} {
    ...
    caseAssume (spec.multiplicand(1)[62:52] != 11'h000)
    caseAssume (spec.multiplicand(1)[62:52] != 11'h7ff)
#    caseEnumerate dnn64_ier -expr spec.multiplier[51:0] -parent dnorm_norm_64 -type leading1
#    caseEnumerate dnn64_and -expr spec.multiplicand[51:0] -parent dnn64_ier -type leading1

    caseBegin norm_dnorm_64
    caseAssume (spec.multiplier(1)[62:52] != 11'h000)
    caseAssume (spec.multiplier(1)[62:52] != 11'h7ff)
    caseAssume (spec.multiplicand(1)[62:52] == 11'h000)
#    caseEnumerate ndn64_ier -expr spec.multiplier[51:0] -parent norm_dnorm_64 -type leading1
    caseEnumerate ndn64_and -expr spec.multiplicand[51:0] -parent norm_dnorm_64 -type leading1
}
